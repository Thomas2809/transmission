...
#define I2C_SDA 25
#define I2C_SCL 32
extern TwoWire secondWire; // Utilisation de TwoWire pour le deuxième bus I2C



#define ADS1115_IIC_ADDRESS0         (0x48)
#define ADS1115_IIC_ADDRESS1         (0x49)
#define DFROBOT_ADS1115_CONVERSIONDELAY         (33)//original 100
...
public:
  ...
  */
  DFRobot_ADS1115(TwoWire *pWire = &Wire1){_pWire = pWire;};
